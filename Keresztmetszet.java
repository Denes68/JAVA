...
public class Keresztmetszet {
    ...
    public static void main(String[] args) {
        System.out.println("\nKeresztmetszet  Gábor Dénes 113C\n");
        ...
        int elemszam=(int) (Math.random()*6)+5;               //azonos elemszam generátor!   
        ...
        //3. Az elemek a -100 és +100 értéktartományba essenek.
         for (int i = 0; i < elemszam; i++) {
           szamtomb1[i] = (int) (Math.random()*201)-100;           //generál -100 és 100 közötti random sámot
        ...
        System.out.println("Szamtomb1 tömb elemei: ");
            for (int i = 0; i < elemszam; i++) {
                System.out.print(String.format("%,4d",  szamtomb1[i])+" ");    // (String.format("%,4d") felel a helyiértékért!
        }
        System.out.println("\n");
        ...
        for (int i = 0; i <=elemszam; i++) {
            ...
            System.out.println("\n");
            System.out.print("Szeretné újra futtatni a programot? igen/nem");
